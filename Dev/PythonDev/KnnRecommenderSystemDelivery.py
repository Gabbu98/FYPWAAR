...
class KnnRecommenderSystemDelivery:
    """
    ...
    def _prep_data(self):
        ...
        df_tasks = pd.read_csv('DataRecommenderSystem/TaskDeliveryVisitor.csv', sep=',', names=columns2)
        df_ratings = pd.read_csv('DataRecommenderSystem/DataDeliveryVisitor.csv', sep=',', names=columns)
        # filter data
        ...
        hashmap = {key:val for key, val in hashmap.items() if val != 100}
...
if __name__ == '__main__':
    ...
    recommender = KnnRecommenderSystemDelivery(
        "","")
    # set params
    recommender.set_filter_params(0.7, 0.7)
    recommender.set_model_params(8, 'brute', 'cosine', -1)
