...
def evaluate_svd(svd_fn, reconstruct_fn, min_rows=100, max_rows=5000, n_samples=100, n_cols=N_COLS, rank=RANK,
                 random_seed=0):
...
plt.legend(("numpy.linalg.svd", "TruncatedSVD (randomized)", "TruncatedSVD (arpack)"))
plt.title("Time to perform SVD (on matrices of rank 50 with 1000 columns)")